...
class TwinningYearlySheet implements FromView, ShouldAutoSize, WithEvents, WithTitle
{
    public function __construct($year, $title, $donations, $total)
    {
        $this->year      = $year;
        $this->title     = $title;
    ...
    {
        return view('exports.reports.twinningyearly', [
            'data'     => $this->donations,
