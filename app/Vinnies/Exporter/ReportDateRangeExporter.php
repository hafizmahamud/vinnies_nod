...
use App\Vinnies\RemittanceDateRangeFactory;
use App\Vinnies\Exporter\Sheets\TwinningDateRangeSheet;
use App\Vinnies\Exporter\Sheets\ProjectsDateRangeSheet;
...
class ReportDateRangeExporter implements WithMultipleSheets, WithProperties, Responsable
{
    use Exportable;
    ...
    {
        $factory = new RemittanceDateRangeFactory($date_type, $date_start, $date_end);
        $factory->populate();
    ...
    public function sheets(): array
    {
        ...
        $sheets[] = new TwinningDateRangeSheet('Twinning', $twinning, $this->total_amount['twinning']);
        $sheets[] = new TwinningDateRangeSheet('Grants', $grants, $this->total_amount['grants']);
        $sheets[] = new TwinningDateRangeSheet('Council to Council', $councils, $this->total_amount['councils']);
        $sheets[] = new ProjectsDateRangeSheet('Projects & Special Works', $projects, $this->total_amount['projects']);
