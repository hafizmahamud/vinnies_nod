...
class CouncilDonationsImporter extends RemittanceImporter
{
    ...
    public function isValidType()
    {
        ...
        return strtolower($types->first()) === 'council to council twinning';
    }
}
